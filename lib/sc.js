...
c.LATIN_SMALL_LETTER_A_WITH_GRAVE = getChar([0xc3, 0xa0]);
c.LATIN_SMALL_LETTER_A_WITH_ACUTE = getChar([0xc3, 0xa1]);
c.LATIN_SMALL_LETTER_A_WITH_CIRCUMFLEX = getChar([0xc3, 0xa2]);
c.LATIN_SMALL_LETTER_A_WITH_TILDE = getChar([0xc3, 0xa3]);
c.LATIN_SMALL_LETTER_A_WITH_DIAERESIS = getChar([0xc3, 0xa4]);
c.LATIN_SMALL_LETTER_A_WITH_RING_ABOVE = getChar([0xc3, 0xa5]);
c.LATIN_SMALL_LETTER_AE = getChar([0xc3, 0xa6]);
